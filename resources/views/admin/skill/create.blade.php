            ...
            <div class="card-text h-full ">
                <form class="space-y-4" method="POST" action="{{ route('admin.skill.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="input-area">
                        ...
                        <textarea id="skill_desc" name="skill_desc" rows="5" class="form-control" placeholder="Type Here">{{ old('skill_desc') }}</textarea>
                        <x-input-error :messages="$errors->get('skill_desc')" class="mt-2" />
                    </div>
                    <div class="input-area">
                        <label for="skill_svg" class="form-label">Skill SVG<span class="text-danger-500">*</span></label>

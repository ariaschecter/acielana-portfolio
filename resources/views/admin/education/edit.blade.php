    ...
    <div class="card">
        <div class="card-body flex flex-col p-6">
            ...
            <div class="card-text h-full ">
                <form class="space-y-4" method="POST" action="{{ route('admin.education.update', $education->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="input-area relative">
                        <label for="education_name" class="form-label">Education Name<span class="text-danger-500">*</span></label>
                        <input type="text" id="education_name" name="education_name" class="form-control" placeholder="Enter Education Name" value="{{ $education->education_name }}">
                    ...
                    <div class="input-area relative">
                        ...
                        <input type="text" id="education_institution" name="education_institution" class="form-control" placeholder="Enter Institution" value="{{ $education->education_institution }}">
                    ...
                    <div>
                        ...
                        <input class="form-control py-2" id="education_start" name="education_start" value="{{ $education->education_start }}" type="date">
                        <x-input-error :messages="$errors->get('education_start')" class="mt-2" />
                      </div>
                    <div>
                        <label for="education_end" class=" form-label">Date End</label>
                        <input class="form-control py-2" id="education_end" name="education_end" value="{{ $education->education_end }}" type="date">
                    ...
                    <div class="input-area">
                        ...
                        <textarea id="education_desc" name="education_desc" rows="5" class="form-control" placeholder="Type Here">{{ $education->education_desc }}</textarea>
                      </div>

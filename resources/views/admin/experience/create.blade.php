    ...
    <div class="card">
        <div class="card-body flex flex-col p-6">
            ...
            <div class="card-text h-full ">
                <form class="space-y-4" method="POST" action="{{ route('admin.experience.store') }}">
                    @csrf
                    <div class="input-area relative">
                        <label for="experience_name" class="form-label">Experience Name<span class="text-danger-500">*</span></label>
                        <input type="text" id="experience_name" name="experience_name" class="form-control" placeholder="Enter Experience Name" value="{{ old('experience_name') }}">
                    ...
                    <div class="input-area relative">
                        ...
                        <input type="text" id="experience_institution" name="experience_institution" class="form-control" placeholder="Enter Institution" value="{{ old('experience_institution') }}">
                    ...
                    <div>
                        ...
                        <input class="form-control py-2" id="experience_start" name="experience_start" value="{{ old('experience_start') }}" type="date">
                        <x-input-error :messages="$errors->get('experience_start')" class="mt-2" />
                      </div>
                    <div>
                        <label for="experience_end" class=" form-label">Date End</label>
                        <input class="form-control py-2" id="experience_end" name="experience_end" value="{{ old('experience_end') }}" type="date">
                    ...
                    <div class="input-area">
                        ...
                        <textarea id="experience_desc" name="experience_desc" rows="5" class="form-control" placeholder="Type Here">{{ old('experience_desc') }}</textarea>

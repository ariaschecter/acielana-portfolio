        ...
        <div class="header__sticky py-5">
          <div class="container mx-auto">
            <div class="flex justify-between items-center">
                <div class="logo">
                    <a href="./index.html">
                      <img class="hidden dark:block" src="{{ asset('frontend/images/logo-light.png') }}" alt="">
          ...
          <div class="offcanvas__inner">
              <div class="offcanvas__logo">
                  <a class="offcanvas__logo_link" href="index.html">
                      <img class="dark:hidden" src="{{ asset('frontend/images/logo.png') }}" alt="Grocee Logo" width="158" height="36">
                      <img class="hidden dark:block" src="{{ asset('frontend/images/logo-light.png') }}" alt="Grocee Logo" width="158" height="36">
                  </a>
            ...
            <div class="container mx-auto flex sm:flex-col items-center justify-center lg:mt-[40px] only-md:mt-[40px] sm:pt-[100px] sm:pb-[70px]">
                <div class="lg:max-w-[40%] sm:max-w-[60%] xs:max-w-[85%] only-md:max-w-[40%] flex justify-end">
                  <div class="relative only-xl:max-w-[70%]">
                      <img class="hidden dark:block" src="{{ asset('frontend/images/hero-man-dark.png') }}" alt="">
                      <img class="dark:hidden" src="{{ asset('frontend/images/hero-man.png') }}" alt="">
                      <span class="absolute top-[100px] lg:top-[210px] right-[-20px] only-md:right-[-10px] only-xl:max-w-[65px] lg:max-w-[80px] xl:max-w-[105px] sm:max-w-[50px] only-md:max-w-[70px] animateUpDown"><img src="{{ asset('frontend/images/photoshop-logo.png') }}" alt=""></span>
                      <span class="absolute top-[80px] left-[-40px] md:left-[-10px] only-xl:max-w-[65px] lg:max-w-[80px] xl:max-w-[105px] sm:max-w-[50px] only-md:max-w-[70px] animateUpDown"><img src="{{ asset('frontend/images/figma.png') }}" alt=""></span>
          ...
          <div class="container mx-auto">
              <div class="flex justify-between sm:flex-wrap sm:flex-col-reverse">
                  ...
                  <div class="sm:mb-[50px]">
                      <div class="relative">
                        <img class="relative z-10 sm:mx-auto" src="{{ asset('frontend/images/about-me.png') }}" alt="">
                   ...
                   <div class="relative overflow-hidden">
                      <a href="#" class="popup-modal--open">
                        ...
                        <div class="w-full portfolio__image--card">
                          <img class="w-full transition duration-300" src="{{ asset('frontend/images/portfolio/1.png') }}" alt="">
                        </div>
                      </a>
                ...
                <div class="element-item mb-[30px] w-[50%] lg:w-[33.33%]  px-[15px] graphics portfolio__parent" data-category="graphics">
                   <div class="relative overflow-hidden">
                    <a href="#" class="popup-modal--open">
                        ...
                        <div class="w-full portfolio__image--card">
                          <img class="w-full transition duration-300" src="{{ asset('frontend/images/portfolio/2.png') }}" alt="">
                        </div>
                    </a>
                ...
                <div class="element-item mb-[30px] w-[50%] lg:w-[33.33%]  px-[15px] development portfolio__parent" data-category="development">
                   <div class="relative overflow-hidden">
                    <a href="#" class="popup-modal--open">
                        ...
                        <div class="w-full portfolio__image--card">
                          <img class="w-full transition duration-300" src="{{ asset('frontend/images/portfolio/3.png') }}" alt="">
                        </div>
                      </a>
                    <!-- Portfolio popup start -->
                    <div class="modal_portfolio fixed h-screen w-full left-0 top-0 z-[98] opacity-0 invisible">
          ...
          <div class="grid grid-cols-1 only-md:grid-cols-2 lg:grid-cols-2">
              <div class="flex">
                <p class="flex items-center flex-wrap sm:justify-center dark:text-slate-200">Developed with <span class="px-[3px] text-paragraph dark:text-white">
                  ...
                  </span>  by <span class=" px-[3px]"><a class="text-accent1 hover:font-bold" href="#">Morex</a></span>© 2022</p>
              </div>

...
<div class="container mx-auto">
            ...
            <div class="flex items-center">
                ...
                <div class="ltr:pl-6 rtl:pr-6">
                    <h3
                        ...
                        Call Me</h3>
                    <span
                        class="text-primary dark:text-slate-200 text-[22px] md:text-[18px] mt-5">++880254615566
                        <br> ++826542556455</span>
                </div>
            </div>
            ...
            <div class="flex items-center lg:mt-7">
                ...
                <div class="ltr:pl-6 rtl:pr-6">
                    <h3
                        ...
                        Email Us</h3>
                    <span
                        class="text-primary  dark:text-slate-200 text-[22px] md:text-[18px] mt-5">rubel@eobi.com
                        <br>
                        moraty@bara.com
                    </span>
                </div>
            ...
            <div class="flex items-center lg:mt-7">
                ...
                <div class="ltr:pl-6 rtl:pr-6">
                    <h3
                        class="text-[28px] md:text-[22px] font-heebo font-bold text-primary dark:text-white">
                        Address</h3>
                    <span class="text-primary  dark:text-slate-200 text-[22px] md:text-[18px] mt-5">20, 25
                        Dhaka,0123 <br>
                        Ratrba baraj,20
                    </span>
                </div>
    ...
    <div class="mb-[-275px] pt-[70px] lg:pt-[100px]">
        <div style="width: 100%"><iframe width="100%" height="400" frameborder="0"

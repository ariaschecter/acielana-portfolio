    ...
    <ul class="toggle__nav--menu relative z-20 invisible text-left pt-[53px] pb-[22px]">
        ...
        <li>
            <a href="/#experience" class="flex items-center">
                ...
                <span
                    class="toggle__nav--menu--label-wrapper relative block h-[45px] leading-[45px] text-primary dark:text-white uppercase text-[16px] before:content[''] before:absolute before:w-[3px] before:h-[16px] before:top-[50%] ltr:before:left-[20px] rtl:before:right-[18px]">
                    <span class="toggle__nav--menu--label font-bold font-heebo block opacity-0">Experience</span>
                </span>
            </a>
        </li>
...
<div
    ...
    <button
        class="bg-accent1 md:w-[45px] md:h-[45px] lg:w-[60px] lg:h-[60px] text-white flex justify-center items-center rounded-full shadow-[0_2px_5px_rgba(0,0,0,0.15)]"
        id="light__to--dark">
        ...
        <ul class="flex justify-around items-center">
            <li>
                <a href="/#home"
                    ...
                    <span class="relative z-10">
                        <svg width="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 576 512">
                            <path
                                d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z" />
                        </svg>
            ...
            <li>
                <a href="/#portfolio"
                    class="mobile--menu__nav--item bg-accent1 w-11 h-11 rounded-full text-white flex items-center justify-center relative transition-all duration-400">
                    <span class="relative z-10">
                        <svg width="16" fill="currentColor" stroke="currentColor"

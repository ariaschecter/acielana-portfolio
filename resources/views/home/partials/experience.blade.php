...
<section class="lg:py-[100px] md:py-[70px]" id="experience">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full max-w-[50%] sm:max-w-full flex-grow">
                <div class="relative ltr:pl-[30px] rtl:pr-[30px]">
                    ...
                    <!-- Single resume start -->
                    <div
                        class="flex ltr:pr-[50px] ltr:sm:pr-[0] ltr:lg:pr-[70px rtl:pl-[50px] rtl:sm:pl-[0] rtl:lg:pl-[70px relative {{ $key > 0 ? 'mt-[40px]' : '' }}">
                        <span
                        ...
                        <div class="flex-grow ltr:pl-[15px] rtl:pr-[15px]">
                            <div
                                ...
                                <h3
                                    ...
                                    {{ $exp->experience_name }}</h3>
                                <span
                                    class="bg-accent1 text-white text-[13px] rounded-[30px] px-[15px] py-[5px] uppercase ltr:ml-[15px] rtl:mr-[15px] ltr:only-md:ml-0 only-md:my-[5px] ltr:2xs:ml-0 rtl:only-md:m-0 rtl:2xs:mr-0 2xs:my-[5px] text-center">{{ $exp->experience_institution }}</span>
                            </div>
                            ...
                            <span class="text-[17px] font-medium text-accent1 relative ltr:pl-[20px] rtl:pr-[20px] before:absolute before:bg-accent1 before:w-[7px] before:h-[7px] ltr:before:left-0 rtl:before:right-0 before:top-[50%] before:translate-y-[-50%] mt-[20px] block">
                                {{ \Carbon\Carbon::parse($exp->experience_start)->format('M Y') }} - {{ $exp->experience_end != null ?  \Carbon\Carbon::parse($exp->experience_end)->format('M Y') : 'Now'}}
                            </span>
                        </div>
                    </div>
                    <!-- Single resume end -->
                ...
                <div class="relative ltr:pl-[30px] rtl:pr-[30px]">
                    ...
                    <div
                        ...
                        <div class="flex-grow ltr:pl-[15px] rtl:pr-[15px]">
                            ...
                            <span class="text-[17px] font-medium text-accent1 relative ltr:pl-[20px] rtl:pr-[20px] before:absolute before:bg-accent1 before:w-[7px] before:h-[7px] ltr:before:left-0 rtl:before:right-0 before:top-[50%] before:translate-y-[-50%] mt-[20px] block">
                                {{ \Carbon\Carbon::parse($edu->education_start)->format('M Y') }} - {{ $edu->education_end != null ?  \Carbon\Carbon::parse($edu->education_end)->format('M Y') : 'Now'}}
                            </span>
                        </div>
                    </div>
                    <!-- Single resume end -->
